...
class Renderer{
    public:
        ...
        void DrawFrame(const std::string& id, int x, int y, int width, int height, int row, int col, int frame, SDL_RendererFlip flip = SDL_FLIP_NONE);
        void DrawFrame(const std::string& id, int x, int y, int width, int height, int row, int col, int frame, double angle, const SDL_Point* center, SDL_RendererFlip flip);
